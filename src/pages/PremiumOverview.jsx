...
function PremiumOverview() {
  return (
    <main
      className="relative min-h-screen overflow-visible bg-[#fff8ef] px-4 py-6 sm:px-6 lg:px-10"
      ...
      <div className="pointer-events-none absolute -right-15 -bottom-15 h-80 w-80 rounded-full bg-[#2ec4b6]/20 blur-3xl" />

      <div className="premium-fade-up mx-auto mb-5 w-full max-w-7xl relative z-50">
        <TopNavbar />
      </div>
